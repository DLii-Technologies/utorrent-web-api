...
exports.rssFeeds = rssFeeds;
/**
 * Parse an array of raw uTorrent RSS feeds into the new format
 */
function rssFilters(filters) {
    let result = [];
